"""
NextGenResume - Main Application
"""
import streamlit as st

# Set page config at the very beginning
st.set_page_config(
    page_title="NextGenResume",
    page_icon="🤖",
    layout="wide"
)
...
class ResumeApp:
       ...
       #from ui_components import apply_modern_styles
        ...
        st.markdown("""
            <div class="hero-section">
                <h1 class="hero-title">Info about NextGenResume</h1>
        ...
        st.markdown("""
            <div class="vision-section">
                ...
                <p class="vision-text">
                    "NextGenResume represents vision of combining cutting-edge AI with intuitive design, this platform empowers job seekers at 
    ...
    def render_feedback_page(self):
        ...
        st.markdown("""
            <div class="feedback-header">
                ...
                <p>Help us improve NextGenResume with your valuable feedback</p>
            </div>
        """, unsafe_allow_html=True)
    ...
    def render_home(self):
        ...
        hero_section(
            "NextGenResume",
            "From ordinary to outstanding—transform your resume with AI precision and style."
        )
        ...
        feature_card(
            "fas fa-robot",
            "AI-Powered Analysis",
            "Get instant feedback on your resume with advanced AI analysis that identifies strengths and areas for your improvement."
        )
